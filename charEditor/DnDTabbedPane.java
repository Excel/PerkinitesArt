   ...
   class DnDTabbedPane extends JTabbedPane {
      ...
      private int getTargetTabIndex(Point glassPt) {
         ...
         for(int i=0;i < getTabCount();i++) {
            ...
            if(i == 0){
               if(isTB) r.setRect(r.x-r.width/2-1000, r.y,  r.width+1000, r.height+1000);
               else   r.setRect(r.x, r.y-r.height/2-1000, r.width+1000, r.height+1000);
            }
            else{
         ...
         if(isTB) r.setRect(r.x+r.width/2, r.y,  r.width+10000, r.height+10000);
         else   r.setRect(r.x, r.y+r.height/2, r.width+10000, r.height+10000);
